                ...
                children: [
                  Text(
                    '${_todoController.currentDateTime.value.year} .'
                        '${_todoController.currentDateTime.value.month} .'
                        '${_todoController.currentDateTime.value.day} '
                        '${_listController.getOfDay(
                        _todoController.currentDateTime.value.weekday)}',
                    style: TextStyle(
                        fontSize: 20,
                          ...
                          Obx(
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                    ...
                                    controller:
                                    _todoController.makeRuleTitleController
                                        .value,
              ...
              child: Container(
                child: Row(
                  ...
                  children: [
                    ...
                    Text('${_todoController.todoTitleList[index].boolOfTime
                        ? '${_todoController.todoTitleList[index].timeRange!
                        .startTime.hour < 12 ? '오전' : '오후'} '
                        '${_todoController.todoTitleList[index].timeRange!
                        .startTime.hour < 13
                        ? '${_todoController.todoTitleList[index].timeRange!
                        .startTime.hour}'
              ...
              children: [
                Row(
                  children: [
                    SizedBox(width: 20),
                    Text(
                      '${_todoController.defaultTime.value.startTime.hour < 12
                          ? '오전'
                          : '오후'} '
                          '${_todoController.defaultTime.value.startTime.hour <
                          13 ? '${_todoController.defaultTime.value.startTime
                          .hour}' : '${_todoController.defaultTime.value
                          .startTime.hour - 12}'} : '
                ...
                Row(
                  children: [
                    Text(
                      '${_todoController.defaultTime.value.endTime.hour < 12
                          ? '오전'
                          : '오후'} '
                          '${_todoController.defaultTime.value.endTime.hour < 13
      ...
      child: Row(
        ...
        children: [
          ...
          widget.editMode == true
            ...
            color: isDarkMode ? darkPrimaryColor : context.theme.primaryColor,
            elevation: 0,
            child: Text(
              '수 정',
              style: TextStyle(
                      ...
                      child: Column(
                        children: [
                          TimeRangePicker(
                            ...
                            ticks: 24,
                            handlerRadius: 8,
                            handlerColor: isDarkMode ? Colors.grey : context
                                .theme.primaryColor,
